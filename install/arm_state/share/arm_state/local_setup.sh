...
: ${AMENT_CURRENT_PREFIX:="/home/user/arm_ros2/install/arm_state"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_state/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_state/environment/path.sh"
